...
// cai pro fallback de grupos/canais (sem mention funcional) — mas NUNCA pra
// chats pessoais (is_personal) de OUTRAS pessoas: um DM via /status só deve
// receber ticket do próprio dono, nunca "sobra" de alguém sem mapeamento
// (senão qualquer ticket de um criador não cadastrado vazava pra todo mundo
// inscrito, sem filtro nenhum — bug real encontrado ao vivo). Cada item
// devolvido tem { chatId, threadId } — threadId vem de telegram_chats.thread_id
