...
// A API pública não devolve nome nem posição do estágio (só o stageId) —
// usa o que estiver salvo em /api/stage-labels (aba Tickets, clique no nome
// da coluna); senão mostra um nome genérico a partir do ID e joga pro fim
// da ordem, pra pelo menos diferenciar as colunas até serem configuradas.
